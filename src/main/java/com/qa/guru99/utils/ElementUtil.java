...
import com.qa.guru99.exceptions.ElementException;
...
public class ElementUtil {
	...
	@Step("checking for the element {0} to be displayed on the page") 
	...
	@Step("waiting for the element using locator {0} within timeout {1} with the interval time of {2}")
